        ...
        "/reminders": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "remind_at is required (use RFC3339, e.g. 2026-03-30T15:00:00Z)",
                        "schema": {
                            "type": "string"
                        }
                    },
    ...
    "definitions": {
        ...
        "data.Reminder": {
            ...
            "properties": {
                ...
                "sent_at": {
                    "description": "SentAt is a nullable DB field: nil maps to NULL (not sent yet).\nomitempty keeps sent_at out of JSON when it is nil.",
                    "type": "string"
                },
                "user_id": {
                    "type": "integer"
